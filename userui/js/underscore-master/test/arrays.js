(function() {
  ...
  QUnit.test('flatten', function(assert) {
    ...
    let result = (function(){ return _.flatten(arguments); }(1, [2], [3, [[[4]]]]));
  ...
  QUnit.test('without', function(assert) {
    ...
    let result = (function(){ return _.without(arguments, 0, 1); }(1, 2, 1, 0, 3, 1, 4));
    assert.deepEqual(result, [2, 3, 4], 'works on an arguments object');
  ...
  QUnit.test('uniq', function(assert) {
    ...
    list = [-2, -1, 0, 1, 2];
    let notInjective = function(x) {return x * x;};
    ...
    let result = (function(){ return _.uniq(arguments); }(1, 2, 1, 3, 1, 4));
    assert.deepEqual(result, [1, 2, 3, 4], 'works on an arguments object');
  ...
  QUnit.test('intersection', function(assert) {
    ...
    let theSixStooges = ['moe', 'moe', 'curly', 'curly', 'larry', 'larry'];
  ...
  QUnit.test('object', function(assert) {
    ...
    let stooges = {moe: 30, larry: 40, curly: 50};
  ...
  QUnit.test('lastIndexOf', function(assert) {
    let numbers = [1, 0, 1];
    let falsy = [void 0, '', 0, false, NaN, null, void 0];
    ...
    let result = (function(){ return _.lastIndexOf(arguments, 1); }(1, 0, 1, 0, 0, 1, 0, 0, 0));
    ...
    numbers = [1, 2, 3, 1, 2, 3, 1, 2, 3];
    let index = _.lastIndexOf(numbers, 2, 2);
    ...
    let expected = _.map(falsy, function(value) {
      return typeof value == 'number' ? -1 : 5;
    });

    let actual = _.map(falsy, function(fromIndex) {
